...
1. [SourceForge](https://sourceforge.net/projects/winclaw/files/latest/download) または [GitHub Releases](https://github.com/itc-ou-shigou/winclaw/releases) から `WinClawSetup-{version}.exe` をダウンロード（リポジトリの [`releases/`](releases/) ディレクトリからも取得可能）
...
## macOS / Linux / Windows クロスプラットフォームインストール (npm)

npm パッケージは **Windows / macOS / Linux** 全プラットフォーム対応です。Node.js 22+ のみ必要：
