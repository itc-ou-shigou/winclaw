...
1. [SourceForge](https://sourceforge.net/projects/winclaw/files/WinClawSetup-2026.2.30.exe/download) または [GitHub Releases](https://github.com/itc-ou-shigou/winclaw/releases) から `WinClawSetup-{version}.exe` をダウンロード（リポジトリの [`releases/`](releases/) ディレクトリからも取得可能）
