---
name: winclaw-cron
description: Create, edit, delete, and manage scheduled tasks (cron jobs) in WinClaw/WinClaw. Use when the user asks to schedule recurring actions, set up automated reports, create reminders, run periodic checks, manage timers, or asks about "every morning", "daily", "weekly", "hourly" automated tasks.
