...
read_when:
  - You want to publish a third-party WinClaw plugin
...
This page tracks high-quality **community-maintained plugins** for WinClaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `winclaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `winclaw plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect WinClaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/winclaw-wechat`
  repo: `https://github.com/icesword0760/winclaw-wechat`
  install: `winclaw plugins install @icesword760/winclaw-wechat`
