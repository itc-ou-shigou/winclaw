...
read_when:
  - You are building a WinClaw plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (winclaw.plugin.json)

Every plugin **must** ship a `winclaw.plugin.json` file in the **plugin root**.
WinClaw uses this manifest to validate configuration **without executing plugin
