...
winclaw system heartbeat last
winclaw logs --follow
winclaw config get agents.defaults.heartbeat
winclaw channels status --probe
```
...
```bash
winclaw config get agents.defaults.heartbeat.activeHours
winclaw config get agents.defaults.heartbeat.activeHours.timezone
winclaw config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
winclaw cron list
winclaw logs --follow
```
