...
WinClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.winclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["winclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
