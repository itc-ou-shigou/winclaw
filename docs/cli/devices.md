...
### `winclaw devices remove <deviceId>`

Remove one paired device entry.

```
winclaw devices remove <deviceId>
winclaw devices remove <deviceId> --json
```

### `winclaw devices clear --yes [--pending]`

Clear paired devices in bulk.

```
winclaw devices clear --yes
winclaw devices clear --yes --pending
winclaw devices clear --yes --pending --json
```
