...
- Install via CLI: `winclaw plugins install @winclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `winclaw plugins install ./extensions/zalo`
   - From npm (if published): `winclaw plugins install @winclaw/zalo`
...
- Approve via:
  - `winclaw pairing list zalo`
  - `winclaw pairing approve zalo <CODE>`
...
- Example: `winclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `winclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `winclaw logs --follow`
