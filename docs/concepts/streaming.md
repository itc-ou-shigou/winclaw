...
WinClaw has two separate “streaming” layers:
...
When block streaming is enabled, WinClaw can **merge consecutive block chunks**
...
When draft streaming is active, WinClaw disables block streaming for that reply to avoid double-streaming.
