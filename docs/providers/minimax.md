---
summary: "Use MiniMax M2.1 in WinClaw"
read_when:
...
- Use `winclaw models list` and `winclaw models set minimax/MiniMax-M2.1` to switch.
...
- Running `winclaw configure` and selecting **MiniMax M2.1**, or
