---
summary: "Use Synthetic's Anthropic-compatible API in WinClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. WinClaw registers it as the
...
Note: WinClaw's Anthropic client appends `/v1` to the base URL, so use
