...
You can point WinClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or WinClaw
...
- [Anthropic provider](/providers/anthropic) - Native WinClaw integration with Claude setup-token or API keys
