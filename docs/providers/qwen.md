---
summary: "Use Qwen OAuth (free tier) in WinClaw"
read_when:
  - You want to use Qwen with WinClaw
...
If you already logged in with the Qwen Code CLI, WinClaw will sync credentials
