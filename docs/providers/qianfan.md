---
summary: "Use Qianfan's unified API to access many models in WinClaw"
read_when:
...
3. WinClaw installed on your system
...
4. Copy the API key for use with WinClaw

## CLI setup

```bash
winclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [WinClaw Configuration](/gateway/configuration)
