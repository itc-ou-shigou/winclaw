---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with WinClaw"
read_when:
  - You want Xiaomi MiMo models in WinClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). WinClaw uses
