---
summary: "Use NVIDIA's OpenAI-compatible API in WinClaw"
read_when:
  - You want to use NVIDIA models in WinClaw
...
winclaw onboard --auth-choice skip
winclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
