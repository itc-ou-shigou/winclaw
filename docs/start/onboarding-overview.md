---
summary: "Overview of WinClaw onboarding options and flows"
read_when:
...
WinClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`winclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the WinClaw app when you want a fully guided setup on macOS. Docs:
