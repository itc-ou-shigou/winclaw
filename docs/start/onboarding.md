---
summary: "First-run onboarding flow for WinClaw (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give WinClaw">
...
<Step title="CLI">
  ...
  The app can install the global `winclaw` CLI via npm/pnpm so terminal
