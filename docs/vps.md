---
summary: "VPS hosting hub for WinClaw (Oracle/Fly/Hetzner/GCP/exe.dev)"
read_when:
...
- `WINCLAW_NO_RESPAWN=1` avoids extra startup overhead from a self-respawn path.
...
- Add service env for stable startup path:
  - `WINCLAW_NO_RESPAWN=1`
  - `NODE_COMPILE_CACHE=/var/tmp/winclaw-compile-cache`
