...
- Keep product names in English: WinClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the WinClaw Gateway, use “Gateway 网关”.
