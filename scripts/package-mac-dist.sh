...
# Output:
# - dist/WinClaw.app
# - dist/WinClaw-<version>.zip
# - dist/WinClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.winclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/WinClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/WinClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/WinClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/WinClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/WinClaw-$VERSION.dSYM.zip"
