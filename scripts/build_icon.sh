...
# Defaults target the WinClaw assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/WinClaw/Resources/WinClaw.icns"}
