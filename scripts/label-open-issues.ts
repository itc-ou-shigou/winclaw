...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "winclaw", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for WinClaw. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("WinClaw Issue Label Audit");
