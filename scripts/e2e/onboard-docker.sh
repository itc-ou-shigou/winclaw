...
TRASH
  ...
  send_skills_flow() {
    ...
    workspace_dir="$HOME/.winclaw/workspace"
    config_path="$HOME/.winclaw/winclaw.json"
    sessions_dir="$HOME/.winclaw/agents/main/sessions"
...
NODE
  ...
  run_case_reset() {
    ...
    # Seed a remote config to exercise reset path.
	    cat > "$HOME/.winclaw/winclaw.json" <<'"'"'JSON'"'"'
{
