...
} from "winclaw/plugin-sdk/account-id";
import { isSecretRef } from "winclaw/plugin-sdk/googlechat";
import type { WinClawConfig } from "winclaw/plugin-sdk/googlechat";
...
export function listGoogleChatAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: WinClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: WinClawConfig): ResolvedGoogleChatAccount[] {
