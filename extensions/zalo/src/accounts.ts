...
export function listZaloAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: WinClawConfig): string {
...
function mergeZaloAccountConfig(cfg: WinClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: WinClawConfig): ResolvedZaloAccount[] {
