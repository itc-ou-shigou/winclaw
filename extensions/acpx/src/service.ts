import type {
  ...
  PluginLogger,
} from "winclaw/plugin-sdk/acpx";
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "winclaw/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: WinClawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: WinClawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
