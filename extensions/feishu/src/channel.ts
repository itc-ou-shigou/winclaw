import type { ChannelMeta, ChannelPlugin, ClawdbotConfig } from "winclaw/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "winclaw/plugin-sdk";
