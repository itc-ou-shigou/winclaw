...
import type { WinClawPluginApi } from "winclaw/plugin-sdk/feishu";
...
function readConfiguredDefaultAccountId(config: WinClawPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<WinClawPluginApi, "config">;
