...
import type { ReplyPayload, WinClawConfig } from "winclaw/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "winclaw/plugin-sdk/twitch";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as WinClawConfig;
