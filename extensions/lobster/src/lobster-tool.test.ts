...
import type { WinClawPluginApi, WinClawPluginToolContext } from "winclaw/plugin-sdk/lobster";
...
describe("lobster plugin tool", () => {
  ...
  beforeAll(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "winclaw-lobster-plugin-"));
  });
