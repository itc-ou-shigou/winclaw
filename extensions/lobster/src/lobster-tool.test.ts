...
import type { WinClawPluginApi, WinClawPluginToolContext } from "../../../src/plugins/types.js";
import { createLobsterTool } from "./lobster-tool.js";

async function writeFakeLobsterScript(scriptBody: string, prefix = "winclaw-lobster-plugin-") {
...
function fakeApi(overrides: Partial<WinClawPluginApi> = {}): WinClawPluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<WinClawPluginToolContext> = {}): WinClawPluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: WinClawPluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
