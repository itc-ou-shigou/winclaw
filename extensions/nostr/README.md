...
Nostr DM channel plugin for WinClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to WinClaw. It enables your bot to:
...
# Configure winclaw to use local relay
