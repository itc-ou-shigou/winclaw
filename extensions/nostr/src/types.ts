...
import type { WinClawConfig } from "winclaw/plugin-sdk/nostr";
...
function resolveConfiguredDefaultNostrAccountId(cfg: WinClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: WinClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: WinClawConfig): string {
