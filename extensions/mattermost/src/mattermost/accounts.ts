...
import type { WinClawConfig } from "winclaw/plugin-sdk/mattermost";
...
export function listMattermostAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: WinClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: WinClawConfig): ResolvedMattermostAccount[] {
