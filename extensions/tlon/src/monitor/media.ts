...
import { fetchWithSsrFGuard } from "winclaw/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to WinClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".winclaw", "workspace", "media", "inbound");
 ...
 * Format matches WinClaw's expected attachment structure.
 */
