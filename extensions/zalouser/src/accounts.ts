...
import type { WinClawConfig } from "winclaw/plugin-sdk/zalouser";
...
export function listZalouserAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: WinClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: WinClawConfig, accountId: string): ZalouserAccountConfig {
