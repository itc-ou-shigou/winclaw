...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "winclaw/plugin-sdk/msteams";
...
import { resolvePreferredWinClawTmpDir } from "../../../src/infra/tmp-winclaw-dir.js";
import {
  type MSTeamsAdapter,
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredWinClawTmpDir(), "msteams-mention-"));
