import type {
  ...
  DmPolicy,
  WizardPrompter,
} from "winclaw/plugin-sdk/bluebubbles";
import {
  DEFAULT_ACCOUNT_ID,
...
function setBlueBubblesDmPolicy(cfg: WinClawConfig, dmPolicy: DmPolicy): WinClawConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your WinClaw gateway URL + webhook path",
