...
import { resolveChannelMediaMaxBytes, type WinClawConfig } from "winclaw/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: WinClawConfig; accountId?: string }): string[] {
