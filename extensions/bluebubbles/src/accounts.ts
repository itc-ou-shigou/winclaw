...
export function listBlueBubblesAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: WinClawConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: WinClawConfig): ResolvedBlueBubblesAccount[] {
