...
This directory contains the **BlueBubbles external channel plugin** for WinClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `winclaw/plugin-sdk` helpers.
