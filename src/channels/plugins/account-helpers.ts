...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: WinClawConfig): string | undefined {
  ...
  function listAccountIds(cfg: WinClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: WinClawConfig): string {
