...
export function listSignalAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: WinClawConfig): string {
...
function mergeSignalAccountConfig(cfg: WinClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: WinClawConfig): ResolvedSignalAccount[] {
