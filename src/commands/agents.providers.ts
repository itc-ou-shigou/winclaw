...
function resolveDefaultAccountId(cfg: WinClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: WinClawConfig): boolean {
...
export function summarizeBindings(cfg: WinClawConfig, bindings: AgentBinding[]): string[] {
