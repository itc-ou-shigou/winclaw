...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.winclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("winclaw hooks list")}`,
      `  ${formatCliCommand("winclaw hooks enable <name>")}`,
      `  ${formatCliCommand("winclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
