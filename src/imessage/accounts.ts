...
export function listIMessageAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: WinClawConfig): string {
...
function mergeIMessageAccountConfig(cfg: WinClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: WinClawConfig): ResolvedIMessageAccount[] {
