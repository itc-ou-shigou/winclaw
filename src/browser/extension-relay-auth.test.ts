...
import {
  probeAuthenticatedWinClawRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated winclaw relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedWinClawRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-winclaw-relay-token",
