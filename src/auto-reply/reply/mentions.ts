...
function resolveMentionPatterns(cfg: WinClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: WinClawConfig | undefined, agentId?: string): RegExp[] {
