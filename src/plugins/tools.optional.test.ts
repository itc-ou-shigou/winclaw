...
const loadWinClawPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadWinClawPlugins: (params: unknown) => loadWinClawPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadWinClawPluginsMock.mockReturnValue(registry);
  return registry;
}
...
describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadWinClawPluginsMock.mockClear();
  });
