...
export type PluginKind = "memory" | "contextEngine";

export type PluginConfigValidation =
  | { ok: true; value?: unknown }
  | { ok: false; errors: string[] };

export type WinClawPluginConfigSchema = {
...
export type WinClawPluginToolContext = {
...
export type WinClawPluginToolFactory = (
  ctx: WinClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type WinClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type WinClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<WinClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type WinClawPluginGatewayMethod = {
  method: string;
 ...
 */
export type WinClawPluginCommandDefinition = {
...
export type WinClawPluginHttpRouteAuth = "gateway" | "plugin";
export type WinClawPluginHttpRouteMatch = "exact" | "prefix";

export type WinClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean | void> | boolean | void;

export type WinClawPluginHttpRouteParams = {
  path: string;
  handler: WinClawPluginHttpRouteHandler;
  auth: WinClawPluginHttpRouteAuth;
  match?: WinClawPluginHttpRouteMatch;
  replaceExisting?: boolean;
};

export type WinClawPluginCliContext = {
  program: Command;
  config: WinClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type WinClawPluginCliRegistrar = (ctx: WinClawPluginCliContext) => void | Promise<void>;

export type WinClawPluginServiceContext = {
  config: WinClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type WinClawPluginService = {
  id: string;
  start: (ctx: WinClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: WinClawPluginServiceContext) => void | Promise<void>;
};

export type WinClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type WinClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: WinClawPluginConfigSchema;
  register?: (api: WinClawPluginApi) => void | Promise<void>;
  activate?: (api: WinClawPluginApi) => void | Promise<void>;
};

export type WinClawPluginModule =
  | WinClawPluginDefinition
  | ((api: WinClawPluginApi) => void | Promise<void>);

export type WinClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | WinClawPluginToolFactory,
    opts?: WinClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: WinClawPluginHookOptions,
  ) => void;
  registerHttpRoute: (params: WinClawPluginHttpRouteParams) => void;
  registerChannel: (registration: WinClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: WinClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: WinClawPluginService) => void;
   ...
   */
  registerCommand: (command: WinClawPluginCommandDefinition) => void;
