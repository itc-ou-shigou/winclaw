...
function expectSecurityConnectError(
  ...
  expect(error.message).toContain("winclaw doctor --fix");
...
describe("GatewayClient security checks", () => {
  const envSnapshot = captureEnv(["WINCLAW_ALLOW_INSECURE_PRIVATE_WS"]);
  ...
  it("allows ws:// to private addresses only with WINCLAW_ALLOW_INSECURE_PRIVATE_WS=1", () => {
