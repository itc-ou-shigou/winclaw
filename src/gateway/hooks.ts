...
export function resolveHooksConfig(cfg: WinClawConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: WinClawConfig, defaultAgentId: string): Set<string> {
