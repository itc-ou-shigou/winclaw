...
function listConfiguredAgentIds(cfg: WinClawConfig): string[] {
...
export function listAgentsForGateway(cfg: WinClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: WinClawConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: WinClawConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: WinClawConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: WinClawConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: WinClawConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: WinClawConfig): GatewaySessionsDefaults {
