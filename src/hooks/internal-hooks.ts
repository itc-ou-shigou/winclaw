/**
 * Hook system for WinClaw agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __winclaw_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__winclaw_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
