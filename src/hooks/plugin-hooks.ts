...
import type { WinClawPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: WinClawPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: WinClawPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
