...
export const A2UI_PATH = "/__winclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__winclaw__/canvas";

export const CANVAS_WS_PATH = "/__winclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.winclawCanvasA2UIAction.postMessage(...)
  // - Android: window.winclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["winclawCanvasA2UIAction"];
  ...
  globalThis.WinClaw = globalThis.WinClaw ?? {};
  globalThis.WinClaw.postMessage = postToNode;
  globalThis.WinClaw.sendUserAction = sendUserAction;
  globalThis.winclawPostMessage = postToNode;
  globalThis.winclawSendUserAction = sendUserAction;
