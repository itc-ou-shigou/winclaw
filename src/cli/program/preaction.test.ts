...
describe("registerPreActionHooks", () => {
  ...
  it("loads plugin registry for configure command", async () => {
    await runCommand({
      parseArgv: ["configure"],
      processArgv: ["node", "winclaw", "configure"],
    });
  ...
  it("loads plugin registry for onboard command", async () => {
    await runCommand({
      parseArgv: ["onboard"],
      processArgv: ["node", "winclaw", "onboard"],
    });
  ...
  it("skips config guard for doctor, completion, and secrets commands", async () => {
    await runCommand({
      parseArgv: ["doctor"],
      processArgv: ["node", "winclaw", "doctor"],
    });
    await runCommand({
      parseArgv: ["completion"],
      processArgv: ["node", "winclaw", "completion"],
    });
    await runCommand({
      parseArgv: ["secrets"],
  ...
  it("hides banner when WINCLAW_HIDE_BANNER is truthy", async () => {
