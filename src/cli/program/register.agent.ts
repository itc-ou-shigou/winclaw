...
${formatHelpExamples([
  ['winclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['winclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'winclaw agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'winclaw agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['winclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.winclaw.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.winclaw.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['winclaw agents set-identity --agent main --name "WinClaw" --emoji "🦞"', "Set name + emoji."],
  ["winclaw agents set-identity --agent main --avatar avatars/winclaw.png", "Set avatar path."],
  [
    "winclaw agents set-identity --workspace ~/.winclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "winclaw agents set-identity --identity-file ~/.winclaw/workspace/IDENTITY.md --agent main",
