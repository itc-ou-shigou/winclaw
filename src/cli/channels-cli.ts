    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["winclaw channels list", "List configured channels and auth profiles."],
          ["winclaw channels status --probe", "Run channel status checks and probes."],
          [
            "winclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["winclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.winclaw.ai/cli/channels",
        )}\n`,
    );
