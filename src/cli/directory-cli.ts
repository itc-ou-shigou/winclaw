    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["winclaw directory self --channel slack", "Show the connected account identity."],
          [
            'winclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["winclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "winclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.winclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
