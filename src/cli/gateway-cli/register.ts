      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["winclaw gateway run", "Run the gateway in the foreground."],
            ["winclaw gateway status", "Show service status and probe reachability."],
            ["winclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["winclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.winclaw.ai/cli/gateway")}\n`,
      ),
  );
