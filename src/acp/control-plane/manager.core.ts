...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: WinClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: WinClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: WinClawConfig; sessionKey: string }): void {
  ...
  private resolveTurnTimeoutMs(params: { cfg: WinClawConfig; meta: SessionAcpMeta }): number {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: WinClawConfig }): Promise<void> {
