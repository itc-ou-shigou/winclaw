...
export function isAcpEnabledByPolicy(cfg: WinClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: WinClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: WinClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: WinClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: WinClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: WinClawConfig, agentId: string): boolean {
