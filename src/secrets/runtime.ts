...
type SecretDefaults = NonNullable<WinClawConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: WinClawConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveWinClawAgentDir()));
