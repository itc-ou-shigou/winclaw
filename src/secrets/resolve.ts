...
function resolveResolutionLimits(config: WinClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: WinClawConfig): SecretProviderConfig {
