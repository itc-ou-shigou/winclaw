...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.winclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", WINCLAW_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.winclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when WINCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.winclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when WINCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", WINCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.winclaw.jbphoenix.plist",
    },
    {
      name: "prefers WINCLAW_LAUNCHD_LABEL over WINCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
    ...
    {
      name: "trims whitespace from WINCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        WINCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty WINCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        WINCLAW_PROFILE: "myprofile",
        WINCLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.winclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
