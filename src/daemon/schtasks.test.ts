...
describe("resolveTaskScriptPath", () => {
  it.each([
    {
      name: "uses default path when WINCLAW_PROFILE is unset",
      env: { USERPROFILE: "C:\\Users\\test" },
      expected: path.join("C:\\Users\\test", ".winclaw", "gateway.cmd"),
    },
    {
      name: "uses profile-specific path when WINCLAW_PROFILE is set to a custom value",
      env: { USERPROFILE: "C:\\Users\\test", WINCLAW_PROFILE: "jbphoenix" },
      expected: path.join("C:\\Users\\test", ".winclaw-jbphoenix", "gateway.cmd"),
    },
    {
      name: "prefers WINCLAW_STATE_DIR over profile-derived defaults",
      env: {
        USERPROFILE: "C:\\Users\\test",
        WINCLAW_PROFILE: "rescue",
        WINCLAW_STATE_DIR: "C:\\State\\winclaw",
      },
      expected: path.join("C:\\State\\winclaw", "gateway.cmd"),
    },
    {
      name: "falls back to HOME when USERPROFILE is not set",
      env: { HOME: "/home/test", WINCLAW_PROFILE: "default" },
      expected: path.join("/home/test", ".winclaw", "gateway.cmd"),
    },
  ])("$name", ({ env, expected }) => {
...
describe("readScheduledTaskCommand", () => {
    ...
    await withScheduledTaskScript(
      {
        scriptLines: [
          "@echo off",
          '"C:\\Program Files\\nodejs\\node.exe" C:\\Users\\test\\AppData\\Roaming\\npm\\node_modules\\winclaw\\dist\\index.js gateway --port 18789',
        ],
      },
      async (env) => {
        const result = await readScheduledTaskCommand(env);
        expect(result).toEqual({
          programArguments: [
            "C:\\Program Files\\nodejs\\node.exe",
            "C:\\Users\\test\\AppData\\Roaming\\npm\\node_modules\\winclaw\\dist\\index.js",
            "gateway",
            "--port",
            "18789",
          ],
    ...
    await withScheduledTaskScript(
      {
        scriptLines: [
          "@echo off",
          '"\\\\fileserver\\WinClaw Share\\node.exe" "\\\\fileserver\\WinClaw Share\\dist\\index.js" gateway --port 18789',
        ],
      },
      async (env) => {
        const result = await readScheduledTaskCommand(env);
        expect(result).toEqual({
          programArguments: [
            "\\\\fileserver\\WinClaw Share\\node.exe",
            "\\\\fileserver\\WinClaw Share\\dist\\index.js",
            "gateway",
            "--port",
            "18789",
          ],
  ...
  it("reads script from WINCLAW_STATE_DIR override", async () => {
    await withScheduledTaskScript(
      {
        env: (tmpDir) => ({ WINCLAW_STATE_DIR: path.join(tmpDir, "custom-state") }),
