...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: WinClawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: WinClawConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__winclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__winclawMcporterColdStartWarned;
  });
