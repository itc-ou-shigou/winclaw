...
/**
 * Resolve provider API override from legacy WinClaw config.
 *
...
function buildLeafSummaryPrompt(params: {
  ...
  return [
    "You summarize a SEGMENT of a WinClaw conversation for future model turns.",
...
export async function createLcmSummarizeFromLegacyParams(params: {
  ...
  const summaryLevels = [
    ...
    {
      levelName: "WinClaw agents.defaults.compaction.model",
