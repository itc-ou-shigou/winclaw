...
let originalWinClawTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalWinClawTestConsole = process.env.WINCLAW_TEST_CONSOLE;
  process.env.WINCLAW_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalWinClawTestConsole === undefined) {
    delete process.env.WINCLAW_TEST_CONSOLE;
  } else {
    process.env.WINCLAW_TEST_CONSOLE = originalWinClawTestConsole;
  }
