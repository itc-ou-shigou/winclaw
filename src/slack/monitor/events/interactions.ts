...
// Prefix for WinClaw-generated action IDs to scope our handler
const WINCLAW_ACTION_PREFIX = "winclaw:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${WINCLAW_ACTION_PREFIX}`);

  // Handle WinClaw modal submissions with callback_ids scoped by our prefix.
