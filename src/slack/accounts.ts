...
export function listSlackAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: WinClawConfig): string {
...
function mergeSlackAccountConfig(cfg: WinClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: WinClawConfig): ResolvedSlackAccount[] {
