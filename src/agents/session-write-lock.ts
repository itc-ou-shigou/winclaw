...
const CLEANUP_STATE_KEY = Symbol.for("winclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("winclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("winclaw.sessionWriteLockWatchdogState");
