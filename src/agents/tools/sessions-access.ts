...
export function resolveSessionToolsVisibility(cfg: WinClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: WinClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: WinClawConfig): AgentToAgentPolicy {
