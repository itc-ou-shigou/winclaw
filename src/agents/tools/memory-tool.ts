...
function resolveMemoryToolContext(options: { config?: WinClawConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: WinClawConfig): MemoryCitationsMode {
