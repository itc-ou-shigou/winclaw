...
function asWinClawConfig(config: Partial<WinClawConfig>): WinClawConfig {
  return config as WinClawConfig;
}

function createToolConfig() {
  return asWinClawConfig({ agents: { list: [{ id: "main", default: true }] } });
}

function createMemoryGetToolOrThrow(config: WinClawConfig = createToolConfig()) {
