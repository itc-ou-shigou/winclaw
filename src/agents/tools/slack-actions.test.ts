...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): WinClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: WinClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: WinClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
