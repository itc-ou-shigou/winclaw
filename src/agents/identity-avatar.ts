...
function resolveAvatarSource(cfg: WinClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: WinClawConfig, agentId: string): AgentAvatarResolution {
