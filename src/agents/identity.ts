import type { WinClawConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveAckReaction(cfg: WinClawConfig, agentId: string): string {
...
export function resolveIdentityNamePrefix(cfg: WinClawConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: WinClawConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[winclaw]";
}
