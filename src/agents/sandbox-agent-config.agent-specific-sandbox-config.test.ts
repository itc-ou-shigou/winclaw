...
async function resolveContext(config: WinClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): WinClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
