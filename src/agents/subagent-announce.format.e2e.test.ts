...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/winclaw/winclaw/issues/31298
    previousFastTestEnv = process.env.WINCLAW_TEST_FAST;
  ...
  afterAll(() => {
    if (previousFastTestEnv === undefined) {
      delete process.env.WINCLAW_TEST_FAST;
      return;
    }
    process.env.WINCLAW_TEST_FAST = previousFastTestEnv;
  });

  beforeEach(() => {
    // WINCLAW_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("WinClaw runtime context (internal):");
