...
export const DEFAULT_SANDBOX_IMAGE = "winclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "winclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "winclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "winclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "winclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "winclaw-sandbox-browser";
