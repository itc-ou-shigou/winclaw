...
describe("agent components", () => {
  const createCfg = (): WinClawConfig => ({}) as WinClawConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/winclaw-sessions-test.json");
  });
