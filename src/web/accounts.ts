...
export function listWhatsAppAuthDirs(cfg: WinClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: WinClawConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: WinClawConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: WinClawConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: WinClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: WinClawConfig): ResolvedWhatsAppAccount[] {
