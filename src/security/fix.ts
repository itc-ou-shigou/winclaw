...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof WinClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: WinClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: WinClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
