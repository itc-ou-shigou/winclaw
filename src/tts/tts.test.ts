...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.WINCLAW_TTS_PREFS;
      process.env.WINCLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.WINCLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: WinClawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
