...
public enum WinClawTalkCommand: String, Codable, Sendable {
...
public struct WinClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct WinClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
