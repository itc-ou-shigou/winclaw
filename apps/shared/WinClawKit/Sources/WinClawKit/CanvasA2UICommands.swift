...
public enum WinClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct WinClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct WinClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
