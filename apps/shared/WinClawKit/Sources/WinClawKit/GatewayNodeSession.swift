...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.winclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.winclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: WinClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
