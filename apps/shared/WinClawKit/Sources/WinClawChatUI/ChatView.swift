...
@MainActor
public struct WinClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: WinClawChatViewModel,
    ...
    private var visibleMessages: [WinClawChatMessage] {
        let base: [WinClawChatMessage]
    ...
    private func mergeToolResults(in messages: [WinClawChatMessage]) -> [WinClawChatMessage] {
    ...
    private func isToolResultMessage(_ message: WinClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: WinClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: WinClawChatMessage) -> String {
