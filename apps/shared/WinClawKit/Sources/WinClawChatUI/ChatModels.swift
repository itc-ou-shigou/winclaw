...
public typealias WinClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias WinClawPlatformImage = UIImage
#endif

public struct WinClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct WinClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: WinClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(WinClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct WinClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct WinClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [WinClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: WinClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [WinClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: WinClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(WinClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([WinClawChatMessageContent].self, forKey: .content) {
...
public struct WinClawChatHistoryPayload: Codable, Sendable {
...
public struct WinClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct WinClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [WinClawSessionPreviewItem]
}

public struct WinClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [WinClawSessionPreviewEntry]

    public init(ts: Int, previews: [WinClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct WinClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct WinClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct WinClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct WinClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct WinClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct WinClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: WinClawPlatformImage?
...
public struct WinClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
