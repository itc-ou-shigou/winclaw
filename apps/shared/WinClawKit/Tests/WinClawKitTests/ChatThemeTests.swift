...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = WinClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = WinClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
