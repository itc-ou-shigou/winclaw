...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.winclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return WinClawConfigFile.defaultWorkspaceURL() }
