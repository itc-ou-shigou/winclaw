...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.winclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other WinClaw windows, but below the system’s pop-up menus.
