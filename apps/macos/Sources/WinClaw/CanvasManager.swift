...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.winclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("WinClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__winclaw__/a2ui/").absoluteString + "?platform=macos"
    }
