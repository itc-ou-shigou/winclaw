...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .winclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? WinClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? WinClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let winclawSelectSettingsTab = Notification.Name("winclawSelectSettingsTab")
}
