...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.winclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        WinClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        WinClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
