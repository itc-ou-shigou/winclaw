...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.winclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".winclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.winclawCommand(
            subcommand: "gateway",
