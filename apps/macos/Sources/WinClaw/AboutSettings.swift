...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/winclaw/winclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/winclaw/winclaw")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "WinClawBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "WinClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "WinClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "WinClawGitCommit") as? String) ??
            "unknown"
    }
