...
enum UIStrings {
    static let welcomeTitle = "Welcome to WinClaw"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: WinClawOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: WinClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g winclaw@\(version)"
    }
