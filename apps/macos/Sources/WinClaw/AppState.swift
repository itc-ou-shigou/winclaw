...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = WinClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = WinClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = WinClawConfigFile.loadDict()
            ...
            WinClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/winclaw"
        state.remoteCliPath = ""
        return state
    }
}
