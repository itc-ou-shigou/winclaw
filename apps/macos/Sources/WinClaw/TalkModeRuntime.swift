...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.winclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.winclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [WinClawChatMessage] = messages.compactMap { item in
