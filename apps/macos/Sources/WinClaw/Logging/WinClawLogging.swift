...
enum WinClawLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = WinClawOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = WinClawFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        WinClawLogging.bootstrapIfNeeded()
        let label = WinClawLogging.makeLabel(subsystem: subsystem, category: category)
...
struct WinClawOSLogHandler: LogHandler {
...
struct WinClawFileLogHandler: LogHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = WinClawLogging.parseLabel(self.label)
