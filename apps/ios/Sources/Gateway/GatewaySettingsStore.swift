...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.winclaw.gateway"
    private static let nodeService = "ai.winclaw.node"
    private static let talkService = "ai.winclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.winclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.winclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("winclaw-gateway.log")
    }
